...
## Overview
The Gold Layer (`dwarehouse_project_gold`) is the business-level data representation, structured to support analytical and reporting use cases. It consists of **dimension tables** and a **fact table** for specific business metrics.
...
| gender           | VARCHAR(20)   | The gender of the customer (e.g., 'Male', 'Female', 'N/A').                                  |
...
| subcategory      | VARCHAR(50)   | A more detailed classification of the product within its category, such as product type.      |
| maintenance      | VARCHAR(20)   | Indicates whether the product requires maintenance (e.g., 'Yes', 'No').                       |
...
| customer_id     | INT           | Identifier linking the order to the customer dimension table.                                 |
