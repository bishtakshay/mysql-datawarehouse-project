...
-- ------------------------------------------;
-- ---  INSERTING IN CRM CUST INFO TABLE  ---;
-- ------------------------------------------;
...
-- ------------------------------------------;
-- ---  INSERTING IN CRM PRD INFO TABLE  ----;
-- ------------------------------------------;
...
SELECT * FROM crm_sales_details
	WHERE sls_ship_dt <= 0 OR LENGTH(sls_ship_dt) != 10;
...
SELECT DISTINCT(cid) FROM erp_cust_a12 WHERE cid LIKE "NAS%";
